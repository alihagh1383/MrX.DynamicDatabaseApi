...
public class FieldsTable : BaseTable
{
    ...
    public List<RolesTable> AddRoles { get; set; } = new();
    public List<RolesTable> DeleteRoles { get; set; } = new();
    public List<RolesTable> UpdateRoles { get; set; } = new();
    public List<RolesTable> ReadRoles { get; set; } = new();
}