...
namespace MrX.DynamicDatabaseApi.CallBack
{
    public class Return
    {
        ...
        {
            this.Location = Location; this.StatusCode = StatusCode; this.Message = Message; Data = data;
        }
        ...
        public static Return Expire(Loc Location, string Message, object? data = null)
            => new Return(Location, 419, Message, data);
        public override string ToString() => JsonConvert.SerializeObject(value: this, formatting: Formatting.Indented, converters: new Newtonsoft.Json.Converters.StringEnumConverter());
        public enum Loc
        {
            Authentication,
            Authorization,
