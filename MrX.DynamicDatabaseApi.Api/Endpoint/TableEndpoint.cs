...
namespace MrX.DynamicDatabaseApi.Api.Endpoint
{
    public class TableEndpoint
    {
        public static Return TableAdd(string Name, DBWUser UM, DBWTabels TM, HttpContext http)
        {
            ...
            var TE = new Database.Table.Dynamic.DynamicTable();
        ...
        public static Return TableAddField(string Name, Guid Row, string FieldName, string Value, DBWUser UM, DBWTabels TM, HttpContext http)
        {
            var T = TM.First(p => p.Name == Name);
            if (T == null)
                return Return.NotExist(Return.Loc.Endpoint, $"Table {Name} Not Exist");
        ...
        public static Return TableUpdateField(string Name, Guid Row, string FieldName, string Value, DBWUser UM, DBWTabels TM, HttpContext http)
        {
            var T = TM.First(p => p.Name == Name);
            if (T == null)
                return Return.NotExist(Return.Loc.Endpoint, $"Table {Name} Not Exist");
        ...
        public static Return TableRemoveField(string Name, Guid Row, string FieldName, DBWUser UM, DBWTabels TM, HttpContext http)
        {
            var T = TM.First(p => p.Name == Name);
            if (T == null)
                return Return.NotExist(Return.Loc.Endpoint, $"Table {Name} Not Exist");
        ...
        public static Return TableGetField(string Name, Guid Row, string FieldName, DBWUser UM, DBWTabels TM, HttpContext http)
        {
            var T = TM.First(p => p.Name == Name);
            if (T == null)
                return Return.NotExist(Return.Loc.Endpoint, $"Table {Name} Not Exist");
            ...
            if (!R.DynamicColumns.ContainsKey(FieldName))
                return Return.Invalid(Return.Loc.Endpoint, $"Table {Name} Field {FieldName} In This Row Is Null");
            return Return.Sucsses(Return.Loc.Endpoint, $"Table {Name} Field {FieldName} In This Row", R.DynamicColumns[FieldName]);
        }
    }
}
